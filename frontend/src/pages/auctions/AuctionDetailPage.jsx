...
import { ArrowLeft, Clock, ShieldCheck, Heart, ChevronDown } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          <div className="flex flex-col">
            ...
            <div className="relative aspect-square md:aspect-[4/3] lg:aspect-square bg-[#e0dfd9] w-full mb-4 group overflow-hidden">
              ...
              {auctionStatus === 'live' && (
                <StatusDot status="live" size="xs" className="absolute top-4 right-4 z-10" />
              )}
              <img 
            ...
            <div className="grid grid-cols-3 border border-[#dcd9ce] mb-8 divide-x divide-[#dcd9ce] text-center">
              <div className="p-4">
                <p className="text-[9px] text-gray-400 tracking-[0.2em] font-bold uppercase mb-2">TOTAL BIDS</p>
                <p className="text-[14px] font-mono font-bold text-black">{itemDetails.totalBids}</p>
              </div>
              <div className="p-4">
                <p className="text-[9px] text-gray-400 tracking-[0.2em] font-bold uppercase mb-2">BIDDERS</p>
                <p className="text-[14px] font-mono font-bold text-black flex items-center justify-center gap-1.5">
              ...
              <div className="p-4">
                <p className="text-[9px] text-gray-400 tracking-[0.2em] font-bold uppercase mb-2">RESERVE</p>
                <p className="text-[11px] font-mono font-bold text-[#3b8754] flex items-center justify-center gap-1">
                  MET <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                </p>
              </div>
            </div>
            ...
            <div className="border border-[#dcd9ce] p-6 mb-8 flex flex-col">
              <p className="text-[9px] text-gray-400 tracking-[0.2em] font-bold uppercase flex items-center gap-2">
          ...
          <div className="flex flex-col">
            {/* Headers */}
            <div className="mb-8">
              <p className="text-[10px] text-gray-400 tracking-[0.2em] uppercase font-bold mb-3 flex items-center justify-between">
                <span>{itemDetails.lot} <span className="mx-2">•</span> {itemDetails.year}</span>
                <span className="text-[#3b8754] text-[8px] cursor-pointer hover:underline" onClick={() => setHasBid(!hasBid)}>
            ...
            <div className="border border-[#dcd9ce] p-6 mb-8 flex items-center justify-between">
              <div>
                <p className="text-[9px] text-gray-400 tracking-[0.2em] uppercase font-bold mb-2">TIME REMAINING</p>
                {auctionStatus === 'live' ? (
              ...
              <div className="text-[9px] text-gray-400 tracking-[0.15em] uppercase font-bold flex items-center gap-1 text-right">
              ...
              <>
                <div className="border border-[#dcd9ce] p-6 mb-6">
                  <div className="flex flex-col mb-8">
                    <p className="text-[9px] text-gray-400 tracking-[0.2em] uppercase font-bold mb-4">PLACE BID</p>
                    <div className="flex items-center">
                      <span className="text-[14px] font-mono text-gray-400 mr-4">CHF</span>
                      <Input placeholder="200000000" className="flex-1" inputClassName="text-xl" />
                      <button className="bg-[#3b8754] hover:bg-[#327347] text-white text-[10px] font-bold tracking-[0.1em] uppercase px-4 py-3 ml-4 flex items-center gap-2 transition-colors">
                        BID PLACED <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                      </button>
                    </div>
                  </div>
                  <div className="border-t border-[#dcd9ce] pt-6 flex flex-col gap-4">
                    <div className="flex justify-between items-center">
                      <p className="text-[10px] text-gray-500 tracking-[0.2em] uppercase font-bold">AUTO-BID</p>
                      <Toggle mode="switch" checked={autoBid} onChange={(e) => setAutoBid(e.target.checked)} />
                    </div>
                    {autoBid && (
                      <div>
                        <p className="text-[9px] text-gray-400 tracking-[0.2em] uppercase font-bold mb-2">MAXIMUM AUTO-BID (CHF)</p>
                ...
                <div className="bg-[#eef8f1] border border-[#b2ddbe] p-6 mb-8 text-[#256037] flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-[12px] font-medium opacity-80 mb-6">You are currently the leading bidder.</p>
            ...
            {auctionStatus === 'won' && (
              <div className="bg-[#eef8f1] border border-[#b2ddbe] p-8 mb-8 text-[#256037] flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-2xl font-black tracking-tight mb-2">AUCTION WON</h3>
                <p className="text-[13px] opacity-80 mb-8 max-w-sm">
                  Congratulations! You have successfully acquired this lot. Please proceed to settlement to finalize the transaction.
                </p>
                <Button fullWidth variant="primary" size="lg" className="w-full py-4 text-[11px] bg-[#256037] hover:bg-[#1a4326] border-[#256037]">
            ...
            {auctionStatus === 'lost' && (
              <div className="bg-[#fcf0f0] border border-[#eabebf] p-8 mb-8 text-[#8c2a2a] flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-2xl font-black tracking-tight mb-2">AUCTION ENDED — NOT WON</h3>
                <p className="text-[13px] opacity-80 mb-8 max-w-sm">
                  This lot has been acquired by another bidder. Explore our other active lots to find your next piece.
                </p>
                <Link to="/auctions" className="w-full">
                  <Button fullWidth variant="outline" size="lg" className="py-4 text-[11px] border-[#8c2a2a] text-[#8c2a2a] hover:bg-[#8c2a2a] hover:text-white">
            ...
            <div className="flex flex-col gap-3 mb-8">
              <Button fullWidth variant="primary" size="lg" className="py-4 text-[11px] opacity-50 cursor-not-allowed">
                ACQUIRE INSTANTLY &rarr;
              </Button>
              <div className="flex gap-3">
                <Button fullWidth variant="outline" size="lg" className="py-4 text-[11px] gap-2 border-[#dcd9ce] hover:border-black w-1/2">
                  <Heart className="w-4 h-4" /> WISHLIST
                </Button>
                <Button fullWidth variant="outline" size="lg" className="py-4 text-[11px] gap-2 border-[#dcd9ce] text-gray-500 cursor-default hover:border-[#dcd9ce] w-1/2">
                  <ShieldCheck className="w-4 h-4 text-gray-400" /> VAULT SECURED
                </Button>
              </div>
            </div>

            {/* Bid History */}
            <div className="border border-[#dcd9ce] p-5 flex items-center justify-between cursor-pointer hover:bg-cream-light transition-colors">
              <p className="text-[10px] text-gray-600 tracking-[0.2em] uppercase font-bold">BID HISTORY (6)</p>
