...
const TransactionFilter = ({ activeStatus = 'ALL', onStatusChange, activeType = 'ALL', onTypeChange }) => {
  return (
    <div className="flex flex-col gap-6 mb-12">
      <div className="flex items-center justify-between border-b border-[#dcd9ce] pb-3">
        <div className="w-1/2">
          <SearchBar 
            ...
            inputClassName="text-[10px] tracking-[0.1em] text-gray-400" 
          />
        </div>
      ...
      <div className="flex flex-col xl:flex-row gap-6 xl:gap-12 text-[9px] tracking-[0.2em] font-bold text-gray-500 uppercase mt-2">
