...
const Navbar = () => {
  return (
    <nav className="w-full flex items-center justify-between px-6 md:px-12 lg:px-16 py-6 text-[10px] tracking-[0.15em] uppercase font-bold text-black border-b border-gray-200 bg-[#f4f2eb]">
      ...
      <div className="flex items-center justify-end gap-6 w-48">
        <div className="flex items-center gap-1.5 cursor-pointer hover:text-gray-600 transition-colors">
           <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path><line x1="3" y1="6" x2="21" y2="6"></line><path d="M16 10a4 4 0 0 1-8 0"></path></svg>
        ...
        <button className="bg-black text-white px-5 py-2.5 text-[9px] tracking-[0.2em] font-bold hover:bg-gray-800 transition-colors whitespace-nowrap">
          LOGIN / SIGN UP
        </button>
      </div>
    </nav>
