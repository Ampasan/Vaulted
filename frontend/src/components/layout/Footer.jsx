      ...
      <div className="max-w-400 mx-auto flex flex-col md:flex-row justify-between mb-32">
        ...
        <div className="flex gap-20 md:gap-32 lg:mr-16">
          ...
          <div className="flex flex-col gap-5">
            <h4 className="text-[#4a4a4a] text-[10px] tracking-[0.15em] font-bold uppercase mb-2">Navigate</h4>
            <a href="#" className="text-[#c4c4c4] text-[10px] tracking-[0.15em] font-bold uppercase hover:text-white transition-colors">Marketplace</a>
            <a href="#" className="text-[#c4c4c4] text-[10px] tracking-[0.15em] font-bold uppercase hover:text-white transition-colors">Auctions</a>
            <a href="#" className="text-[#c4c4c4] text-[10px] tracking-[0.15em] font-bold uppercase hover:text-white transition-colors">Asset</a>
            <a href="#" className="text-[#c4c4c4] text-[10px] tracking-[0.15em] font-bold uppercase hover:text-white transition-colors">Portfolio</a>
            <a href="#" className="text-[#c4c4c4] text-[10px] tracking-[0.15em] font-bold uppercase hover:text-white transition-colors">Wishlist</a>
            <a href="#" className="text-[#c4c4c4] text-[10px] tracking-[0.15em] font-bold uppercase hover:text-white transition-colors">Profile</a>
          </div>
